        ...
        if (task.archived === showArchived) {
            ...
            li.innerHTML = `
                ...
                <div class="action-icons">
                    ${!task.startTime && !task.archived ? `<img title="Start" src="start-icon.png" alt="Start" onclick="startTask(${index}); event.stopPropagation();">` : ''}
                    ${task.startTime ? `<img title="Stop" src="stop-icon.png" alt="Stop" onclick="stopTask(${index}); event.stopPropagation();">` : ''}
                    ${task.startTime === null && !task.archived ? `<img title="Archive" src="archive-icon.png" alt="Archivieren" onclick="archiveTask(${index}); event.stopPropagation();">` : ''}
                    ${task.startTime === null && !task.archived ? `<img title="Export" src="export-icon.png" alt="Export" onclick="downloadReceipt(${index}); event.stopPropagation();">` : ''}
